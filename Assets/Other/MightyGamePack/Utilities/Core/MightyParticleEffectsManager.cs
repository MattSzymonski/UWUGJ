/* 
NAME:
    Mighty Particle Effects Manager

DESCRIPTION:
    Easily spawn particles wherever you want, this manager will take care of storing and destroying them after some time

USAGE:
    Add new particles to the list, set its names and prefabs
    To spawn particle call: SpawnParticleEffect(Vector3 position, Quaternion rotation, float timeToDestroy, float spawnDelay, string particleEffectName);
    To spawn random particle call: SpawnRandomParticleEffect(Vector3 position, Quaternion rotation, float timeToDestroy, float spawnDelay, "MyParticle1", "MyParticle2", "MyParticle3")
